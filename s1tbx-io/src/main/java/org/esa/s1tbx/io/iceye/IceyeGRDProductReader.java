...
public class IceyeGRDProductReader extends SARReader {
        ...
        try {
            ...
            for (int i = 0; i < tempNetcdfFile.getRootIFD().getTIFFFields().length; i++) {
                ...
                if (tiffFields.getType() == 2 && tiffFields.getData() != null
                        ...
                        && ((String[]) tiffFields.getData())[0].startsWith(IceyeXConstants.GDALMETADATA)) {
            ...
            final int rasterWidth = Integer
                    .parseInt(this.tiffFeilds.get(IceyeXConstants.NUM_SAMPLES_PER_LINE.toUpperCase()));
            final int rasterHeight = Integer
                    .parseInt(this.tiffFeilds.get(IceyeXConstants.NUM_OUTPUT_LINES.toUpperCase()));
            ...
            product.setStartTime(ProductData.UTC.parse(
                    this.tiffFeilds.get(IceyeXConstants.ACQUISITION_START_UTC.toUpperCase()), standardDateFormat));
            product.setEndTime(ProductData.UTC
                    .parse(this.tiffFeilds.get(IceyeXConstants.ACQUISITION_END_UTC.toUpperCase()), standardDateFormat));
    ...
    private void addAbstractedMetadataHeader(MetadataElement root) {
        ...
        try {
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.PRODUCT,
                    tiffFeilds.get(IceyeXConstants.PRODUCT.toUpperCase()));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.PRODUCT_TYPE,
                    tiffFeilds.get(IceyeXConstants.PRODUCT_TYPE.toUpperCase()));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.SPH_DESCRIPTOR,
                    tiffFeilds.get(IceyeXConstants.SPH_DESCRIPTOR.toUpperCase()));
            ...
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.ACQUISITION_MODE,
                    tiffFeilds.get(IceyeXConstants.ACQUISITION_MODE.toUpperCase()));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.antenna_pointing,
                    tiffFeilds.get(IceyeXConstants.ANTENNA_POINTING.toUpperCase()));
            ...
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.PROC_TIME, ProductData.UTC
                    .parse(tiffFeilds.get(IceyeXConstants.PROC_TIME_UTC.toUpperCase()), standardDateFormat));

            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.ProcessingSystemIdentifier,
                    tiffFeilds.get(IceyeXConstants.PROCESSING_SYSTEM_IDENTIFIER.toUpperCase()));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.CYCLE,
                    Integer.valueOf(tiffFeilds.get(IceyeXConstants.CYCLE.toUpperCase())));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.REL_ORBIT,
                    Integer.valueOf(tiffFeilds.get(IceyeXConstants.REL_ORBIT.toUpperCase())));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.ABS_ORBIT,
                    Integer.valueOf(tiffFeilds.get(IceyeXConstants.ABS_ORBIT.toUpperCase())));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.incidence_near,
                    Double.valueOf(tiffFeilds.get(IceyeXConstants.INCIDENCE_NEAR.toUpperCase())));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.incidence_far,
                    Double.valueOf(tiffFeilds.get(IceyeXConstants.INCIDENCE_FAR.toUpperCase())));
            ...
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.data_take_id,
                    IceyeXConstants.DATA_TAKE_ID_DEFAULT_VALUE);
            ...
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.first_line_time, ProductData.UTC
                    .parse(tiffFeilds.get(IceyeXConstants.FIRST_LINE_TIME.toUpperCase()), standardDateFormat));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.last_line_time, ProductData.UTC
                    .parse(tiffFeilds.get(IceyeXConstants.LAST_LINE_TIME.toUpperCase()), standardDateFormat));
            ...
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.PASS,
                    tiffFeilds.get(IceyeXConstants.PASS.toUpperCase()));
            ...
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.mds1_tx_rx_polar,
                    tiffFeilds.get(IceyeXConstants.MDS1_TX_RX_POLAR.toUpperCase()));

            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.azimuth_looks,
                    Float.valueOf(tiffFeilds.get(IceyeXConstants.AZIMUTH_LOOKS.toUpperCase())));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.range_looks,
                    Float.valueOf(tiffFeilds.get(IceyeXConstants.RANGE_LOOKS.toUpperCase())));

            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.range_spacing,
                    Float.valueOf(tiffFeilds.get(IceyeXConstants.RANGE_SPACING.toUpperCase())));

            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.azimuth_spacing,
                    Float.valueOf(tiffFeilds.get(IceyeXConstants.AZIMUTH_SPACING.toUpperCase())));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.pulse_repetition_frequency,
                    Float.valueOf(tiffFeilds.get(IceyeXConstants.PULSE_REPETITION_FREQUENCY.toUpperCase())));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.radar_frequency,
                    Double.valueOf(tiffFeilds.get(IceyeXConstants.RADAR_FREQUENCY.toUpperCase()))
                            / Constants.oneMillion);
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.line_time_interval,
                    Double.valueOf(tiffFeilds.get(IceyeXConstants.LINE_TIME_INTERVAL.toUpperCase())));
            final int rasterWidth = Integer
                    .parseInt(tiffFeilds.get(IceyeXConstants.NUM_SAMPLES_PER_LINE.toUpperCase()));
            ...
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.num_output_lines,
                    Integer.valueOf(tiffFeilds.get(IceyeXConstants.NUM_OUTPUT_LINES.toUpperCase())));

            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.num_samples_per_line,
                    Integer.valueOf(tiffFeilds.get(IceyeXConstants.NUM_SAMPLES_PER_LINE.toUpperCase())));
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.subset_offset_x,
                    IceyeXConstants.SUBSET_OFFSET_X_DEFAULT_VALUE);
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.subset_offset_y,
                    IceyeXConstants.SUBSET_OFFSET_Y_DEFAULT_VALUE);
            if (isComplex) {
            ...
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.avg_scene_height,
                    Double.valueOf(tiffFeilds.get(IceyeXConstants.AVG_SCENE_HEIGHT.toUpperCase())));

            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.lat_pixel_res,
                    IceyeXConstants.LAT_PIXEL_RES_DEFAULT_VALUE);
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.lon_pixel_res,
                    IceyeXConstants.LON_PIXEL_RES_DEFAULT_VALUE);
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.slant_range_to_first_pixel,
                    Double.valueOf(tiffFeilds.get(IceyeXConstants.SLANT_RANGE_TO_FIRST_PIXEL.toUpperCase())));
            ...
            if (tiffFeilds.get(IceyeXConstants.RANGE_SPREAD_COMP_FLAG.toUpperCase()) != null) {
                rangeSpreadCompFlag = Integer
                        .valueOf(tiffFeilds.get(IceyeXConstants.RANGE_SPREAD_COMP_FLAG.toUpperCase()));
            }
    ...
    private void addSRGRCoefficients(final MetadataElement absRoot) {
        ...
        try {
            utcTime = ProductData.UTC.parse(tiffFeilds.get(IceyeXConstants.GRSR_ZERO_DOPPLER_TIME.toUpperCase()),
                    standardDateFormat);
        ...
        AbstractMetadata.setAttribute(srgrListElem, AbstractMetadata.ground_range_origin,
                Double.valueOf(tiffFeilds.get(IceyeXConstants.GRSR_GROUND_RANGE_ORIGIN.toUpperCase())));

        final String[] coeffStrArray = convertDateStringToStringArrayBySpace(
                tiffFeilds.get(IceyeXConstants.GRSR_COEFFICIENTS.toUpperCase()));
        int cnt = 1;
    ...
    private void addOrbitStateVectors(final MetadataElement absRoot) {
        ...
        try {
            ...
            String[] stateVectorTime = convertDateStringToStringArray(
                    tiffFeilds.get(IceyeXConstants.STATE_VECTOR_TIME.toUpperCase()));
            final int numPoints = stateVectorTime.length;
            final double[] satellitePositionX = convertStringToDoubleArrayBySpace(
                    tiffFeilds.get(IceyeXConstants.ORBIT_VECTOR_N_X_POS.toUpperCase()));
            final double[] satellitePositionY = convertStringToDoubleArrayBySpace(
                    tiffFeilds.get(IceyeXConstants.ORBIT_VECTOR_N_Y_POS.toUpperCase()));
            final double[] satellitePositionZ = convertStringToDoubleArrayBySpace(
                    tiffFeilds.get(IceyeXConstants.ORBIT_VECTOR_N_Z_POS.toUpperCase()));
            final double[] satelliteVelocityX = convertStringToDoubleArrayBySpace(
                    tiffFeilds.get(IceyeXConstants.ORBIT_VECTOR_N_X_VEL.toUpperCase()));
            final double[] satelliteVelocityY = convertStringToDoubleArrayBySpace(
                    tiffFeilds.get(IceyeXConstants.ORBIT_VECTOR_N_Y_VEL.toUpperCase()));
            final double[] satelliteVelocityZ = convertStringToDoubleArrayBySpace(
                    tiffFeilds.get(IceyeXConstants.ORBIT_VECTOR_N_Z_VEL.toUpperCase()));
    ...
    private void addDopplerCentroidCoefficients() {
        ...
        try {
            utcTime = ProductData.UTC.parse(convertDateStringToStringArray(
                    tiffFeilds.get(IceyeXConstants.DC_ESTIMATE_TIME_UTC.toUpperCase()))[0], standardDateFormat);
        ...
        AbstractMetadata.setAttribute(dopplerListElem, AbstractMetadata.slant_range_time,
                Double.valueOf(tiffFeilds.get(IceyeXConstants.DC_REFERENCE_PIXEL_TIME.toUpperCase())) * 1e9);
        ...
        String[] coefValueS = convertDateStringToStringArrayBySpace(
                tiffFeilds.get(IceyeXConstants.DC_ESTIMATE_COEFFS.toUpperCase()));
    ...
    private void addTiePointGridsToProduct() {
        ...
        final double slantRangeToFirstPixel = Double
                .parseDouble(tiffFeilds.get(IceyeXConstants.SLANT_RANGE_TO_FIRST_PIXEL.toUpperCase())); // in m
        final double rangeSpacing = Double.parseDouble(tiffFeilds.get(IceyeXConstants.RANGE_SPACING.toUpperCase())); // in
                                                                                                                     // m
        final boolean srgrFlag = tiffFeilds.get(IceyeXConstants.SPH_DESCRIPTOR.toUpperCase())
                .equalsIgnoreCase(IceyeXConstants.GRD);
        ...
        final double nearRangeIncidenceAngle = Double
                .parseDouble(tiffFeilds.get(IceyeXConstants.INCIDENCE_NEAR.toUpperCase()));
    ...
    private void addSlantRangeTime(final Product product) {
        ...
        try {
            coefList.utcSeconds = ProductData.UTC
                    .parse(this.tiffFeilds.get(IceyeXConstants.GRSR_ZERO_DOPPLER_TIME.toUpperCase()),
                            standardDateFormat)
                    .getMJD() * 24 * 3600;
    ...
    private void setRangeDist(MetadataElement absRoot, List<CoefList> segmentsArray, int gridWidth, int gridHeight,
        ...
        final double lineTimeInterval = Double
                .parseDouble(this.tiffFeilds.get(IceyeXConstants.LINE_TIME_INTERVAL.toUpperCase()));
        final double startSeconds = ProductData.UTC
                .parse(this.tiffFeilds.get(IceyeXConstants.FIRST_LINE_TIME.toUpperCase()), standardDateFormat).getMJD()
                * 24 * 3600;
